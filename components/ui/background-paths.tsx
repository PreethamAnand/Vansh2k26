...
export function FloatingPathsLayer({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "pointer-events-none absolute inset-0 overflow-hidden bg-white/95 dark:bg-neutral-950",
        className,
      )}
      aria-hidden="true"
    >
      ...
      <FloatingPaths position={-1} />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.65)_0%,rgba(255,255,255,0.9)_35%,rgba(255,255,255,1)_80%)] dark:bg-[radial-gradient(circle_at_top,rgba(5,5,10,0.6)_0%,rgba(5,5,10,0.85)_40%,rgba(5,5,10,1)_85%)]" />
    </div>
  );
}
