...
const MailingList = () => {
  ...
  return (
    <div className="w-full relative bg-[linear-gradient(206deg,_#4E0088_13.13%,_#180029_86.33%)] overflow-hidden flex flex-col items-center pt-4 pb-20">
      ...
      <FadeInView delay={0.5} className="relative mt-10 md:mt-20 z-20 w-[90%] md:w-[800px] h-[150px] md:h-[240px] pointer-events-none">
        <Image
      ...
      <div
        className={`mt-4 md:mt-10 w-full flex flex-col items-center px-4 md:px-6 relative z-30 font-kanit`}
      >
