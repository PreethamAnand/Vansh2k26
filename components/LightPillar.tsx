...
const mixBlendModeClassMap: Partial<Record<NonNullable<CSSProperties["mixBlendMode"]>, string>> = {
  lighten: styles.blendLighten,
  normal: styles.blendNormal,
  screen: styles.blendScreen,
};
...
export default function LightPillar({
  ...
  if (!webGLSupported) {
    return (
      <div
        className={cn(styles.fallback, mixBlendModeClassMap[mixBlendMode], className)}
      />
    );
  }
  ...
  return (
    <div
      ref={containerRef}
      className={cn(styles.container, mixBlendModeClassMap[mixBlendMode], className)}
    />
  );
}